        ...
        <main id="main">
              ...
              <div class="row same-height">
                ...
                <div class="col-md-6 text-block height">
                  <div class="centered">
                    ...
                    <a href="istorijat.html" class="btn btn-primary btn-lg">Pročitaj više</a>
                  </div>
                </div>
              </div>
              <div class="row same-height">
                ...
                <div class="col-md-6 text-block height">
                  <div class="centered">
                    ...
                    <a href="#" class="btn btn-primary btn-lg">Pročitaj više</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="browse-block">
            ...
            <div class="browse-adventures column">
              <a href="#"><span>PRETRAŽITE PRENOĆIŠTA</span></a>
            </div>
          </div>
                  ...
                  <article class="col-sm-6 col-md-4 article has-hover-s1">
                    <div class="thumbnail">
                      ...
                      <p>
                       ...
                       <!-- Button opštirnije -->
						<button type="button" class="btn btn-info-sub btn-sm bounceInLeft animated" style="visibility: visible; animation-name: bounceInLeft;" data-toggle="modal" data-target="#myModal11">
						  Погледајте више
						</button>
                ...
                <div class="row db-3-col">
                  <article class="col-sm-6 col-md-4 article has-hover-s1">
                    <div class="thumbnail">
                      ...
                      <h3 class="small-space">
                        <a href="tour-detail.html">„Румфест“ 2019.</a>
                      </h3>
                      <span class="info"
                        >Lorem ipsum dolor sit amet consectetur adipisicing
                        elit.</span
