        ...
        >
          <div class="banner-text">
            <div class="center-text">
              <div class="container">
                <h1>Arheološka nalazišta i arheologija</h1>
                <strong class="subtitle"
                  >Turistička organizacija opštine Ruma</strong
                >
                <!-- breadcrumb -->
              </div>
            </div>
          ...
          <div class="featured-content adventure-holder">
            <div class="container-fluid">
              ...
              <div class="row same-height">
                <div class="col-md-6 image height">
                  <div class="bg-stretch">
                    <img
                      src="img/gallery/arheologija1Ruma.jpg"
                      height="627"
                      width="960"
                      alt="image description"
                    />
                ...
                <div class="col-md-6 text-block height">
                  <div class="centered">
                    <h2 class="intro-heading">Arheološko nalazipte opštine Ruma</h2>
                    <p class="intro">
              ...
              <!-- istorija slika levo kraj-->

              <!-- istorija slika desno  -->
              <div class="row same-height">
                <div class="col-md-6 image height">
                  <div class="bg-stretch">
                    <img
